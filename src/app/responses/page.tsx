...
const questionLabelOverrides: Record<string, string> = {
  "phase1_scope.dayOneRequirement": "Day-one requirement",
  "phase1_scope.feature": "Feature",
  "inspection_operating_model.scoring_method": "Inspection scoring method",
  "inspection_operating_model.fail_evidence_standard": "Required proof for failed inspections",
  ...
  "offline_requirements.detail": "Offline work and sync details",
  "delivery_expectations.phase1_timeline_weeks": "Phase 1 timeline (weeks)",
  "delivery_expectations.production_ready_definition": "Definition of production-ready",
  "delivery_expectations.support_model": "Post-launch support model",
  ...
  "integration_operating_model.adp_latency_tolerance": "ADP timing expectation",
  ...
  "analytics_operating_model.management_rollup_expectations": "Leadership summary expectations",
  "operations_controls.work_item_urgency_rules": "Work item urgency rules",
  "operations_controls.assignee_notification_escalation": "Reminder and escalation rules",
